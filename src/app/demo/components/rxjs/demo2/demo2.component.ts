...
import { throttleTime, debounceTime, map, skip, takeUntil } from 'rxjs/operators';
...
export class Demo2Component implements OnInit {
   ...
   */
  solution1() {
    this.button1$.subscribe(() => this.increaseCounter('button1'));
  }
   ...
   */
  solution2() {
    this.button2$.pipe(throttleTime(5000)).subscribe(() => this.increaseCounter('button2'));
  }
   ...
   */
  solution3() {
    this.button3$.pipe(debounceTime(this.debounceDelay)).subscribe(() => this.increaseCounter('button3'));
  }
  ...
  solution4() {
    this.button4$
      .pipe(map((event) => {console.log(event); return this.multiplyAmount;}))
  ...
  solution6() {
    ...
    this.button6$
      ...
      .subscribe((result) => {
        console.log(result);
        console.log(this.counters.button6);
